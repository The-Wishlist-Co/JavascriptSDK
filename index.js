...
const getProductByID=require("./productService/getProductByID");
const getProductByRef=require("./productService/getProductByRef");
const getProductByRef2=require('./productService/getProductByRef2');
const getProductVariants=require("./productService/getProductVariants");
const getVariantByID=require("./productService/getVariantByID");
const productSearch=require("./productService/productSearch");
const validateProductID=require("./productService/validateProductID");
const validateProductRef=require("./productService/validateProductRef");
const createNewProduct=require('./productService/createNewProduct')
const updateProduct=require('./productService/updateProduct');
const updateProductByID=require('./productService/updateProductByID');
const updateProductByRef=require('./productService/updateProductByRef');
const createProductVariant=require('./productService/createProductVariant');
const updateProductVariant=require('./productService/updateProductVariant');
const updateVariantByID=require('./productService/updateVariantByID');
const updateVariantByRef=require('./productService/updateVariantByRef');
const updateVariantPrice=require('./productService/updateVariantPrice');
const deleteProductByID=require('./productService/deleteProductByID');
const deleteProductByRef=require('./productService/deleteProductByRef');
const getEmailResultData=require('./productService/getEmailResultData');
const validateProductRequest=require('./productService/validateProductRequest');
const getMockChartData=require('./productService/getMockChartData');
const createBulkProduct=require('./productService/createBulkProduct');
const validateProductVariant=require('./productService/validateProductVariant');
const getVariantByVariantID=require('./productService/getVariantByVariantID');
const deleteVariantByID=require('./productService/deleteVariantByID');
const getVariantByRef=require('./productService/getVariantByRef');
const getVariantByRef2=require('./productService/getVariantByRef2');
const deleteVariant=require('./productService/deleteVariant');
const deleteVariantByRef=require('./productService/deleteVariantByRef');
...
const createNewCustomer=require('./customerService/createNewCustomer');
const updateCustomerByID=require('./customerService/updateCustomerByID');
const addCustomerAddress=require('./customerService/addCustomerAddress');
...
const validateCustomer=require('./customerService/validateCustomer');
const deleteCustomerByID=require('./customerService/deleteCustomerByID');
const deleteCustomerAddress=require('./customerService/deleteCustomerAddress');
const createBulkCustomers=require('./customerService/createBulkCustomers');
const syncEmarsysCustomer=require('./customerService/syncEmarsysCustomer');
